...
from tjpcov_new.covariance_fourier_ssc import \
    FourierSSCHaloModel
...
def test_get_covariance_block(tracer_comb1, tracer_comb2):
    ...
    cov_ssc = cssc.get_covariance_block(tracer_comb1=tracer_comb1,
                                        tracer_comb2=tracer_comb2,
                                        include_b_modes=False)

    # Check saved file
    covf = np.load(outdir + '/ssc_{}_{}_{}_{}.npz'.format(*tracer_comb1,
                                                          *tracer_comb2))
    ...
    cov_ssc_zb = cssc.get_covariance_block(tracer_comb1=tracer_comb1,
                                           tracer_comb2=tracer_comb2,
